...
6. Do not optimize or modify the content - just extract it as-is
  ...
  "projects": [
    ...
    const anthropicResponse = await fetch('https://api.anthropic.com/v1/messages', {
      ...
      body: JSON.stringify({
        ...
        system: 'You are an expert resume parser. Extract resume data into structured JSON format exactly as provided in the resume. Do not optimize or modify content - just extract it accurately. Always return valid JSON only.',
        messages: [
          {
            role: 'user',
            content: prompt

...
`
  ...
  const generatePreviewHTML = () => {
    ...
    } else if (template.id === 'modern-tech') {
      const { modernTechTemplate } = require('@/lib/resume-templates')
      return modernTechTemplate.generateHTML(sampleResumeData)
    } else if (template.id === 'creative-portfolio') {
      const { creativePortfolioTemplate } = require('@/lib/resume-templates')
      return creativePortfolioTemplate.generateHTML(sampleResumeData)
    } else if (template.id === 'executive-leadership') {
      const { executiveLeadershipTemplate } = require('@/lib/resume-templates')
      return executiveLeadershipTemplate.generateHTML(sampleResumeData)
    }
